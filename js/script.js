...
// var headerMenuFirst = document.querySelector(".header_ul-li");
...
const modileAnimBody = document.querySelector("body");
var privs = 0;
let previus = 1;
const MenuTop = document.querySelector(".header_under-menu");
const headerMenuFirst = document.querySelectorAll(".header_ul-li");
...
headerMenuFirst[1].addEventListener("click", function (e) {
...
function mobileMenuAnimation() {
  ...
  modileAnimBody.classList.toggle("open-menu_fix");
